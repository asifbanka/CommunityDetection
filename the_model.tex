...
Let $\mat{P}$ be an $n \times n$ transition matrix of an absorbing Markov chain in canonical form 
...
where $s$ is the number of absorbing states of the Markov chain and $m$ is the number 
of non-zero entries of $\mat{P}$.  
\end{lemma}   
