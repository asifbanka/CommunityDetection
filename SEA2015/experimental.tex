...
these plots is the average over 100 iterations using the same parameters. Due to 
lack of space, the exact details of how we generate seed nodes, classify nodes into 
