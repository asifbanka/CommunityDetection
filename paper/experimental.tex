...
which we can use and this would necessiate choosing different ``magic numbers'' for every network 
...
This suggests the following srategy. Sort the affinities of a node in non-increasing order and let this 
...
there is a likely to be a sharp decrease in affinitites for the communitites that the node does 
not belong in. This is what is captured by the computing the difference in affinitites.
