...
plots for the iterative method (with 10 iterations). A comparison of the 
non-iterative and iterative method is shown in Figure~\ref{fig:compare_iter_overlap}. 
...
$10\%$ at best. The percentage of seed nodes per community required in the 
