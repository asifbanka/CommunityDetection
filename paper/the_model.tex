...
and \emph{low affinity} if it does not. \texttt{Where are we using these definitions? 
if not, I suggest removing them as they do not serve to explain anything.--Somnath} 
Intermediate affinity values are 
