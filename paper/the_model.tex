...
Since we are dealing with infinte random walks we sumarize the following 
imporatant property of absorbing Markov chains, which can be shown by a geometric argument.
...
For normal random walks this is not necesarily the case.
...
Furthermore, the probability that such an infinte random walk starting at non-seed node~$u_i$ ends up at the seed 
