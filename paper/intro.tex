...
communitites was proposed by Palla \etal~\cite{PDFV05}. A community, in this case, is defined to be a set of nodes 
...
\paragraph{Using random walks to model information flow.} Rosvall and Bergman  
